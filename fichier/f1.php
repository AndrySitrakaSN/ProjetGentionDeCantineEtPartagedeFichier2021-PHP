...
if(isset($_POST['go']))
{
  ...
  if( $objet && $mess && $fichier != NULL ){
   ...
   // $tafa = " fichier public envoyer ";
   
   header("location:andex.php");

  }
  else{
    $tsitafa = "impossible d'envoyer car la contenu  est vide !";
  }
...
<img src="../image/1666847760493.jpg" alt="" width="100" height="100">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ajout de fichier public</h1>
        <div class="btn-toolbar mb-2 mb-md-0">

        <div class="btn-group me-2">
            
            <a href="andex.php" class="btn btn-sm btn-secondary"> 
               <img src="../image/ad.jpg" alt="" width="20" height="20"> &thinsp;  Public </a>
          </div>
          <div class="btn-group me-2">
            
            <a href="f1.php" class="btn btn-sm btn-dark"> 
...
<div class=" btn-success"> <?php echo $tero;?></div></h1>
                
<br>      
<center>
<div class="text-danger"> <?php echo $tsitafa ; ?> </div>
<div class="text-success"> <?php echo $tafa ; ?> </div>
</center>
