...
<form action="nm.php" method="POST" class="form-inline">
    <input type="text" name="goo" class=" form-control " placeholder="Nom ou Prenom" >
            ...
            <table class="table  table-borderless">
                             <header>
                              ...
                              <?php
                               ...
                               $req = mysqli_query($conn , "SELECT *FROM utilisateur where nom='$rara' || prenom='$rara' ");
                              if(mysqli_num_rows($req)== 0)
                                         {
                                             $eo = "introvable";
                                         }
                                ...
                                <tr class="table-secondary">
                                    <td><img src="../admin/photos/<?php echo $row['photos'] ?>" alt="" width="80" height="80"> </td> 
                                    <td >Numero : <br> <span class="btn btn-success"><?php echo $row['numUt'];  ?> </span> </td>
                                    <td> Nom :<br><br><?php echo $row['nom']; ?> <br> </td>
                                    <td> Prenom : <br><br><?php echo $row['prenom']; ?></td>
                                    <td>Direction : <br><br><?php echo $row['direction']; ?></td>
                                  
                                </tr> 
         </table>
<span ><center class="btn-danger"><?php echo $eo ; ?></center></span>
            </div>  <br>
        <form action="nmessage1.php" method="POST" enctype="multipart/form-data">
                <p>
