...
<?php
 echo ($row['nom'] . " " . $row['prenom']); }} ?></a>
  ...
  <form action="andex1.php" method="POST" class="form-inline">
    ...
    &thinsp;<input type="submit" name="goa" class="btn btn-success form-control" value="Chercher"  >
                </form> 
...
<img src="../image/1666847760493.jpg" alt="" width="100" height="100">
  ...
  <tr class="table-success ">
        <td> <img src="../admin/photos/<?php echo $row['photos'] ?>" alt="" width="60" height="60"></td>
       <td> <?php echo $row['nom']; ?></td>
       <td> <?php echo $row['prenom']; ?> </td>
       <td> <?php echo $row['direction']; ?></td>
       <td> <span class="btn-dark text-white"><?php echo $row['objett']; ?></span> </td>
       <th><?php echo $row['messagi']; ?> </th>
       <th>
        <center>
        <a href="principal/<?php echo $row['fic']; ?>"> <img src="../image/[036931].jpg" alt="" width="30" height="30">
           </a>
        </center>
        </th>
  </tr>
