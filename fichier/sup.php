...
<?php    session_start();
           ...
           if(isset($_GET['sup']))
           {
             ...
             $req = mysqli_query($conn , "SELECT fic FROM principal where id = $id  ");
           ...
           { 
            ...
            $fafa = unlink($lalana);
                ...
                if ($conn->query($sql) === TRUE) {
                                                      //  echo("voafafa");
                                                      header("location:liste _public.php");
                                                 }
...
<form class="supp.php" method="POST">
      ...
      <a href="liste _public.php" class="btn btn-primary">NON</a>
