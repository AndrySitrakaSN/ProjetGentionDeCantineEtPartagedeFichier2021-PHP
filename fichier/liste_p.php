...
<?php
 echo ($row['nom'] . " " . $row['prenom']); }} ?></a>
  ...
  <form action="liste_p.php" method="POST" class="form-inline">
    <input type="text" name="raha" class=" form-control " placeholder="Objet" >
    &thinsp;<input type="submit" name="mitady" class="btn btn-success" value="Chercher"  >
                </form> 
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-group me-2">
          ...
          <div class="btn-group me-2">
            ...
            <a href="liste _public.php" class="btn btn-sm btn-dark"> 
      ...
      <table class="table table-bordered  ">
                       <tr class="table-dark ">
                          ...
                          if(mysqli_num_rows($req)== 0)
                                     {
                                         ?>
                                     <span class="text-danger"> <?php $ttr = ("Introuvable !"); ?></span>
                                         <?php 
                                     }
                        else{
                                  while($row=mysqli_fetch_assoc($req)) {
        ...
        <a href="principal/<?php echo $row['fic']; ?>"> <img src="../image/[036931].jpg" alt="" width="30" height="30">
                              ...
                              <th class="table-"><center><a href="sup.php?sup=<?php echo $row['id']; ?>"><img src="../image/sip.png" alt="" width="30" height="30"></a></center></th>
                          </tr>
                          <?php }} ?>
                  </table>
        <CENter> <span class="text-danger"> <?php echo $ttr ; ?></span></CENter>
