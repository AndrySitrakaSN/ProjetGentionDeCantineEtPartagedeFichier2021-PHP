      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
             ...
             Mercredi</a> &thinsp;
             <a href="../pdf/mercredi.php" class="btn btn-sm btn-secondary"> 
...
<a href="d1.php" class="btn btn-secondary">Lundi</a> 
     ...
     <a href="d3.php" class="btn btn-dark tesxt-white">Mercredi</a>
...
?>
        <tr class="table-secondary">
            ...
            <th><center><a href= "supa3.php?supp=<?php echo $row['numUt'];?>"><img src="../image/sip.png" alt="" width="30" height="30"> </a></center></th>
        </tr>
        </td> <?php }} ?>        
</table>
</div>
