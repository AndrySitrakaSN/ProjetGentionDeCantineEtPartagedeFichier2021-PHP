...
<img src="../image/1666847760493.jpg" alt="" width="100" height="100">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Compte des utilisateur</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <a href="#" class="btn btn-sm btn-dark">
            <img src="../image/list.png" alt="" width="20" height="20">  
            Liste </a>
            <a href="../pdf/compte.php" class="btn btn-sm btn-secondary"> 
...
<p class="btn btn-secondary"> Semaine du Lundi <span class="btn btn-dark text-white "><?php  echo $lundi; ?></span> 
aux Vendredi <span class="btn btn-dark text-white "><?php echo $vendredi; ?></span> </p>
     <!-- ito ny recherche -->  
<div class="container-fluid">
...
$sql =" SELECT photos ,numUt , nom , prenom ,direction ,id_ut ,count(id_ut) as nbr,valeur  from utilisateur , 
