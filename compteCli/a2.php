...
<html lang="en">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <a href="a2.php" class="btn btn-sm btn-dark">
 ...
 <div class="btn-group">
<a href="a1.php" class="btn btn-secondary ">Lundi</a> 
     <a href="a2.php" class="btn btn-dark text-white">Mardi</a> 
...
&thinsp;
<?php  echo " commande"; ?><div class="btn "><div class="btn btn-dark"><?php print_r( $isa ['numUt'] );?></div> 
</div></div>
</h1>  
